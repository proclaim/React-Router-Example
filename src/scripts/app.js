...
Routes = (
    /* jshint ignore:start */
    React.createElement(Route, {path: "/", handler: MainPage}, 

        React.createElement(Route, {name: "home", handler: HomeView}
        ), 
        React.createElement(Route, {name: "inbox", handler: InboxView}, 
            React.createElement(Route, {path: ":id", handler: View1})
        ), 
...
},{"./pages/404":197,"./pages/main":198,"./views/Home":199,"./views/Inbox":200,"./widgets/Message":201,"react":"nakDgH","react-router":14}],197:[function(require,module,exports){
'use strict';
var React = require('react');
			...
			React.createElement("div", {className: "fourteen wide column"}, 
				React.createElement("h3", null, "Logo"), 
					React.createElement("div", {className: "ui menu"}, 
						React.createElement("a", {className: "item", href: "#/home"}, 
							React.createElement("i", {className: "home icon"}), "Home"
						), 
						React.createElement("a", {className: "item", href: "#/inbox"}, 
							React.createElement("i", {className: "inbox icon"}), "Inbox"
						)		
					), 

					React.createElement("div", {class: "ui grid"}, 
						React.createElement("div", {class: " centered row"}, 
							
							React.createElement("div", {class: "twelve wide column"}, 
...
module.exports = Main;
},{"react":"nakDgH","react-router":14}],199:[function(require,module,exports){
'use strict';
var React = require('react');
...
var Home = React.createClass({displayName: "Home",
	...
	render: function() {
		return (
			/* jshint ignore: start */
			React.createElement("div", null, "This is home view")
			/* jshint ignore: end */
		);
	}
});
...
module.exports = Home;
},{"react":"nakDgH"}],200:[function(require,module,exports){
'use strict';
var React = require('react'),
	Router = require('react-router'),    
    RouteHandler = Router.RouteHandler;
...
var Inbox = React.createClass({displayName: "Inbox",	
	render: function() {
		return (
			/* jshint ignore: start */
			React.createElement("div", null, "this is inbox view", 
				React.createElement(RouteHandler, {params: this.props.params})
			)
			/* jshint ignore: end */
		);
...
},{"react":"nakDgH","react-router":14}],201:[function(require,module,exports){
'use strict';
var React = require('react'),
	Router = require('react-router');    
...
},{"react":"nakDgH","react-router":14}]},{},[196])